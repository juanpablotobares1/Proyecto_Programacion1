...
<body background="imagenes/fondo2.jpg">
	...
	<div class="col-md-6">
		<div style="background-color: #BCA9F5; border-radius: 20px;">
			<form action="Registro1u.php" method="POST" class="margen">
				<h1>Agregar Usuario</h1><br>
				<table>
					<tr><td><p>Usuario:</p></td><td><input type="text" name="usr"></td></tr>
					<tr><td><p>Clave:</p></td><td><input type="text" name="pass"></td></tr>
				</table>
